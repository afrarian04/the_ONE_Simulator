 ...
 *
 */
public class DistributedBubbleRapCentrality implements RoutingDecisionEngine, CommunityDetectionEngine, CentralityDetectionEngine
{
	 ...
	 */
	public DistributedBubbleRapCentrality(Settings s)
	{
	 ...
	 */
	public DistributedBubbleRapCentrality(DistributedBubbleRapCentrality proto)
	{
	...
	public void doExchangeForNewConnection(Connection con, DTNHost peer)
	{
		...
		DistributedBubbleRapCentrality de = this.getOtherDecisionEngine(peer);
...
//		double time = startTimestamps.get(peer);
	...
	public boolean shouldSendMessageToHost(Message m, DTNHost otherHost)
	{
		...
		DistributedBubbleRapCentrality de = getOtherDecisionEngine(otherHost);
	...
	public boolean shouldDeleteSentMessage(Message m, DTNHost otherHost)
	{
		...
		DistributedBubbleRapCentrality de = this.getOtherDecisionEngine(otherHost);
	...
	{
		DistributedBubbleRapCentrality de = this.getOtherDecisionEngine(hostReportingOld);
		return de.commumesWithHost(m.getTo()) && 
			!this.commumesWithHost(m.getTo());
	}
	...
	{
		return new DistributedBubbleRapCentrality(this);
	}
	...
	private DistributedBubbleRapCentrality getOtherDecisionEngine(DTNHost h)
	{
		MessageRouter otherRouter = h.getRouter();
		assert otherRouter instanceof DecisionEngineRouter : "This router only works " + 
		" with other routers of same type";
		
		return (DistributedBubbleRapCentrality) ((DecisionEngineRouter)otherRouter).getDecisionEngine();
	}
    ...
    public double getGlobalDegreeCentrality() {
        return this.centrality.getGlobalCentrality(connHistory); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public double getLocalDegreeCentrality() {
        return this.centrality.getLocalCentrality(connHistory, community); //To change body of generated methods, choose Tools | Templates.
    }
